...
- api.subscribe(filters, onEvent, opts?) -> returns an unsubscribe() function (live, incl. new events; outbox-routed). If you call subscribe, RETURN the unsubscribe function from your code so it is cleaned up when the view closes. NOTE: subscribe does NOT paginate its stored-events backlog (it's a live feed); for a large historical backfill use api.query, which does.
