// auth.js — the "Log in" flow, for either Claude (Anthropic) or Gemini (Google).
//
...
// locally. Both providers' inference endpoints allow direct browser access
 ...
 *
 * @param {string} apiKey
 * @returns {Promise<{ provider: 'anthropic'|'google', models: string[] }>}
 */
